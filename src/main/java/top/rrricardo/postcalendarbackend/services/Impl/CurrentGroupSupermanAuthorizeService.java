...
@Service("currentGroupSuperman")
public class CurrentGroupSupermanAuthorizeService implements AuthorizeService {
    private final GroupLinkMapper groupLinkMapper;
    private final Logger logger;

    public CurrentGroupSupermanAuthorizeService(GroupLinkMapper groupLinkMapper) {
        this.groupLinkMapper = groupLinkMapper;
        this.logger = LoggerFactory.getLogger(CurrentGroupSupermanAuthorizeService.class);
    }
